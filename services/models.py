...
class Services(models.Model):
    ...
    subtitle = models.CharField(max_length=250, null=False, blank=False, verbose_name="short description:")
    image = models.ImageField(upload_to=upload_image_path, null=False, blank=False, validators=[validate_image_extension], verbose_name="original photo:", help_text="resulotion(1150*1035)")
    content = tinymce_models.HTMLField(null=False, blank=False,verbose_name='content:')
    cover = models.ImageField(upload_to=upload_image_path, blank=True, null=True, validators=[validate_image_extension], verbose_name="cover photo:", help_text="resulotion(1920*600)")
    slug = models.SlugField(blank=True,null=True, unique=True, db_index=True, help_text="url website")
...
class Gallery(models.Model):
    timestamp = models.DateTimeField(auto_now_add=True, verbose_name="date:")
    image = models.ImageField(upload_to=upload_image_gallery_path, null=True, blank=True, validators=[validate_image_extension], verbose_name="slider photo:", help_text="resulotion(1200*600)")
    service = models.ForeignKey(Services, on_delete=models.CASCADE, verbose_name='service:')

    class Meta:
        verbose_name = 'gallery'
        verbose_name_plural = 'slider gallery'
